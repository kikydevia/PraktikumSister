...
public class ReadWriteAudio extends javax.swing.JFrame {
    ...
    private void btreadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btreadActionPerformed
        ...
        int res = chooser.showOpenDialog(ReadWriteAudio.this);
        if(res == JFileChooser.APPROVE_OPTION){
            ...
            try{
                ...
                Logger.getLogger(ReadWriteAudio.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadWriteAudio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReadWriteAudio().setVisible(true);
            }
        });
    }
