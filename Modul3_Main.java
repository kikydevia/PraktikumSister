 ...
 * @author ASUS
 */
public class Modul3_Main {
    
    public static void main(String[] args) throws IOException {
        
        String fileName = "F:/dataMahasiswa.txt";
        String fileBaru = "F:/dataBaru.txt";
        ArrayList<Modul3_Participant> datamu = new ArrayList<Modul3_Participant>();
        Modul3_Serialization task = new Modul3_Serialization();
        ArrayList<Modul3_Participant> newList = null;
        ...
        for(;;){
            ...
            switch(choice){
                case 1 : 
                         ...
                         datamu.add(new Modul3_Participant(a, b, c, d));
                         task.Serialize(datamu, fileName);
                    break;
                case 2 : System.out.println("Menampilkan data : ");
                         newList = (ArrayList<Modul3_Participant>) task.print(fileName);
